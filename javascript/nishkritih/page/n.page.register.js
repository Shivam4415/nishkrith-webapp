...
N.Page.Register = (function () {
  ...
  function btnsubmit() {
    ...
    const btnnSignup = function (userName, userEmail, userPassword, userPhone, userAddress, userDob, userGender) {
      var defer = $.Deferred();
      $.ajax({
        url: apiUrl+"/register",
        method: 'POST',
        data: { email: userEmail, password: userPassword, name: userName, phone: userPhone, address: userAddress, dobirth: userDob, gender: userGender },
        dataType: 'json',
    ...
    btnnSignup(lname, remail, rpassword, rphone, raddress, dateofbirth, rgender).done(function () {
    });
